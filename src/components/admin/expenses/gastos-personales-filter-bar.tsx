...
/**
 * Filtro de MES de Gastos personales (eje fecha_gasto, hora Cancún). Va por
 * querystring: el server component recarga con el periodo aplicado y el
 * resumen por moneda/medio siempre corresponde al mes elegido.
 */
export function GastosPersonalesFilterBar({ mes }: { mes: string }) {
